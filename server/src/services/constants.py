...
SANDBOX_LAST_ACTIVITY_AT_LABEL = "opensandbox.io/last-activity-at"
...
class SandboxErrorCodes:
    ...
    K8S_PVC_EXPAND_FAILED = "KUBERNETES::PVC_EXPAND_FAILED"
    K8S_PVC_SHRINK_NOT_SUPPORTED = "KUBERNETES::PVC_SHRINK_NOT_SUPPORTED"
    K8S_VOLUME_EXPANSION_NOT_SUPPORTED = "KUBERNETES::VOLUME_EXPANSION_NOT_SUPPORTED"
    K8S_RESOURCE_UPDATE_FAILED = "KUBERNETES::RESOURCE_UPDATE_FAILED"
